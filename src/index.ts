...
import AlternateLanguageLinksRule from './rules/AlternateLanguageLinksRule'
...
const plugin: Plugin = {
  ...
  rules: {
    ...
    'nice-checkers/alternate-language-links': AlternateLanguageLinksRule,
  ...
  configs: {
    recommended: {
      rules: {
        ...
        'nice-checkers/alternate-language-links': ['error'],
